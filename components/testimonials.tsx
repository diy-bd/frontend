...
const testimonials = [
  {
    ...
    company: 'Disney',
    content:
      'A Dhaka-based startup partnered with Agent DiY to implement AI-powered marketing automation and conversion optimization. By leveraging personalized customer journeys and targeted campaigns, the brand saw a 150% increase in online sales within just three months, while reducing customer acquisition costs by 30%.',
    slug: 'Startup E-commerce Brand Boosts Sales by 150% in 3 Months',
    categories: [1, 2],
  },
  {
    ...
    company: 'Samsung',
    content:
      'An established retail company integrated Agent DiY’s intelligent CRM system to centralize customer data and automate communications. This resulted in a 40% improvement in repeat purchase rates and a 25% increase in average order value, driving sustainable growth and stronger customer loyalty.',
    slug: 'Established Retailer Enhances Customer Engagement with CRM Integration',
    categories: [1, 3],
  },
  {
    ...
    company: 'Rio',
    content:
      'Agent DiY worked with a local SME to develop an ethical brand strategy focused on transparency and sustainability. This approach increased brand trust, leading to a 35% growth in market share within six months and positive recognition in the community.',
    slug: 'Ethical Brand Consulting Drives Trust & Market Share for Local SME',
    categories: [1, 4],
  },
  {
    ...
    company: 'Canon',
    content:
      'A tech startup utilized Agent DiY’s AI-driven performance marketing services to optimize ad spend and target high-converting customer segments. The campaign delivered a 3X return on investment, significantly accelerating the startup’s digital footprint and funding opportunities.',
    slug: 'Performance Marketing Campaign Delivers 3X ROI for Tech Startup',
    categories: [1, 5],
  },
  {
    ...
    company: 'Cadbury',
    content:
      'A growing e-commerce platform adopted Agent DiY’s marketing automation tools to manage lead nurturing and customer follow-ups. Automation reduced manual workload by 50%, improved customer retention by 20%, and enabled the business to scale operations without proportional increases in staffing.',
    slug: 'E-commerce Platform Scales Efficiently with AI Automation Tools',
    categories: [1, 2],
  },
];
...
export default function Testimonials() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 sm:px-6" id="success-stories">
      <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-400/.25),transparent)1] md:py-20">
        ...
        <div className="mx-auto max-w-3xl pb-12 text-center">
          ...
          <p className="text-lg text-indigo-200/65">
            Showcasing real-world business transformations, Agent DiY's Success
            Stories highlight measurable client growth through AI, digital
            marketing, automation, and ethical branding solutions.
          </p>
        </div>

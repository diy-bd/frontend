        ...
        <div className="flex-1 lg:flex lg:items-center lg:-mx-6">
          <div className="text-white lg:w-1/2 lg:mx-6">
            ...
            <p className="max-w-xl mt-6">
              We’re excited to help your business thrive with AI-driven digital
              solutions. Reach out to us with your questions, project ideas, or
              to schedule a consultation. Our team at Agent DiY is here to
